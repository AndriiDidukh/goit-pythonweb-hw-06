...
Revision ID: 04d83e9a59aa
Revises: 
Create Date: 2026-05-20 15:14:01.085814
...
def upgrade() -> None:
    ...
    op.create_table('association_student_group',
    ...
    op.create_table('association_teacher_subject',
...
def downgrade() -> None:
    ...
    op.drop_table('association_teacher_subject')
    op.drop_table('association_student_group')
